...
test: lint        ## Run tests and generate coverage report.
	$(ENV_PREFIX)pytest -v --cov-config .coveragerc --cov=wellets_cli -l --tb=short --maxfail=1 tests/
...
release:          ## Create a new tag for release.
	...
	@echo "$${TAG}" > wellets_cli/VERSION
	@$(ENV_PREFIX)gitchangelog > HISTORY.md
	@sed -i -E "/version/s/.*/version = \"$${TAG}\"/" pyproject.toml
	@git add wellets_cli/VERSION HISTORY.md pyproject.toml
...
switch-to-poetry: ## Switch to poetry package manager.
	...
	@echo "wellets_cli = 'wellets_cli.__main__:main'" >> pyproject.toml
	...
	@echo "Please run 'poetry shell' or 'poetry run wellets_cli'"
