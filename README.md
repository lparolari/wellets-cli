...
- 🎯 Entry points to execute your program using `python -m <wellets_cli>` or `$ wellets_cli` with basic CLI argument parsing.
...
Awesome wellets_cli created by lparolari

## Install it from PyPI

```bash
pip install wellets_cli
```

## Usage

```py
from wellets_cli import BaseClass
from wellets_cli import base_function
